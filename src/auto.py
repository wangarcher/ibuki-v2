...
class poseblock():
    def __init__(self):
        ...
        self.sub_ch2 = rospy.Subscriber('/silva/auto_local/ch2', Evans, self.ch2_cb)    # ch2 for respeaker (neck)
        self.sub_ch3 = rospy.Subscriber('/silva/auto_local/ch3', Evans, self.ch3_cb)    # ch3 for rplidar (hip?)
